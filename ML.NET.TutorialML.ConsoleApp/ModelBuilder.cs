...
namespace ML_NET_TutorialML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\User\Source\repos\ML.NET.Tutorial\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\User\AppData\Local\Temp\MLVSTools\ML.NET.TutorialML\ML.NET.TutorialML.Model\MLModel.zip";
